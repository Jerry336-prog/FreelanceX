      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="mb-4 inline-flex items-center" aria-label="FreelanceX home">
              <img src="/freelancex-logo.svg" alt="FreelanceX" className="h-8 w-auto" />
            </a>
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-6">
              FreelanceX is a modern marketplace connecting ambitious businesses with top-tier independent professionals around the globe.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#browse-jobs" className="text-slate-400 hover:text-white transition-colors">Browse Jobs</a></li>
              <li><a href="#freelancers" className="text-slate-400 hover:text-white transition-colors">Freelancers</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Affiliate Program</a></li>
            </ul>
          </div>
