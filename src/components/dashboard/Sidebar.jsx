...
import { 
  LayoutDashboard, Search, FileText, Briefcase, 
  CreditCard, TrendingUp, MessageSquare, Bell, 
...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/freelancer', icon: <LayoutDashboard className="w-5 h-5" />, end: true },
    { name: 'Browse Jobs', path: '/freelancer/jobs', icon: <Search className="w-5 h-5" /> },
    { name: 'My Proposals', path: '/freelancer/proposals', icon: <FileText className="w-5 h-5" /> },
    { name: 'My Contracts', path: '/freelancer/contracts', icon: <Briefcase className="w-5 h-5" /> },
    { name: 'Payments', path: '/freelancer/payments', icon: <CreditCard className="w-5 h-5" /> },
    { name: 'Earnings', path: '/freelancer/earnings', icon: <TrendingUp className="w-5 h-5" /> },
    { name: 'Messages', path: '/freelancer/messages', icon: <MessageSquare className="w-5 h-5" /> },
    { name: 'Notifications', path: '/freelancer/notifications', icon: <Bell className="w-5 h-5" /> },
    { name: 'Profile', path: '/freelancer/profile', icon: <User className="w-5 h-5" /> },
    { name: 'Settings', path: '/freelancer/settings', icon: <Settings className="w-5 h-5" /> },
  ];
