...
import { Bell, Briefcase, DollarSign, MessageSquare, AlertCircle, CheckCircle, Trash2, Loader2 } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">Stay updated on your freelance activity.</p>
        </div>
        {unreadCount > 0 && (
          <button
